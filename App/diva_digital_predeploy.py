...
if os.path.exists(LOGO_PATH):
    ...
    st.markdown("""
        <h1 class="brand-title">DIVA DIGITAL</h1>
        <p class="brand-subtitle">Empodera tu estrategia digital con datos inteligentes</p>
    """, unsafe_allow_html=True)
...
<div class="content-card">
    ...
    <p style="font-size: 1.1rem; margin-bottom: 0;">
        Diva Digital combina <strong>inteligencia artificial</strong>, <strong>análisis predictivo</strong> y 
